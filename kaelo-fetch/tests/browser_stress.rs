...
//! Run with: `cargo test -p kaelo-fetch --test browser_stress --all-features -- --ignored`

use std::collections::HashMap;
use std::time::{Duration, Instant};

use kaelo_core::types::FetchRequest;
use kaelo_fetch::backend::FetchBackend;
use kaelo_fetch::backends::{shutdown_browser_pool, HeadlessBrowser};
